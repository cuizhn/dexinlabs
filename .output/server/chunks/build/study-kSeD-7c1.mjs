...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "info-page" }, _attrs))} data-v-6212097b><section class="info-page__header" data-v-6212097b><div class="container" data-v-6212097b><span class="info-page__tag" data-v-6212097b>同步学习</span><h1 class="info-page__title" data-v-6212097b>跟着节奏，稳步前行</h1>`);
      _push(ssrRenderComponent(ContentRenderer, {
        content: md,
...
const study = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6212097b"]]);

export { study as default };
//# sourceMappingURL=study-kSeD-7c1.mjs.map
