...
import { e as createError$1, n as parseURL, h as encodePath, o as decodePath, r as hasProtocol, v as isScriptProtocol, w as joinURL, x as withQuery, y as sanitizeStatusCode, z as getContext, $ as $fetch, A as baseURL, B as defu, C as executeAsync } from '../_/nitro.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__nuxt_content/courses/sql_dump.txt") {
      r.unshift({ data: $0 });
    } else if (p === "/__nuxt_content/chapters/sql_dump.txt") {
      r.unshift({ data: $0 });
    }
...
const _routes = [
  {
    name: "courses-slug-chapter",
    path: "/courses/:slug()/:chapter()",
    component: () => import('./_chapter_-DannMS97.mjs')
  },
  {
    name: "courses-slug",
    path: "/courses/:slug()",
    component: () => import('./index-DREXVcPK.mjs')
  },
  {
    name: "courses",
    path: "/courses",
    component: () => import('./index-D3GEx0zy.mjs')
  },
  {
    name: "knowledge",
    path: "/knowledge",
    component: () => import('./index-C8KJpsDh.mjs')
  },
  {
    name: "practice",
    path: "/practice",
    component: () => import('./index-BinQ1QQX.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-W1woyAwv.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BABe_xnB.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BDPgm3z8.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CyyQ6bQc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-C6IKL5cF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C1cT4AsX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C3SJQAsK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BFoXsE6U.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-3bktmzoE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CLpPbYW0.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-5blll6zm.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-GIv_Y2Nn.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cx8Wsdvg.mjs'));
...
export { useRuntimeConfig as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, useRoute as e, useSeoMeta as f, useRouter as g, encodeRoutePath as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useHead as u };
