...
import { p as parseURL, h as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, r as joinURL, w as withQuery, v as sanitizeStatusCode, x as getContext, $ as $fetch, y as hash, z as defu, e as createError$1, A as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./_lesson_-CYCmkBCd.mjs')
  },
  {
    name: "course-chapter",
    path: "/course/:chapter()",
    component: () => import('./index-BkwOXq9j.mjs')
  },
  {
    name: "exercise-chapter",
    path: "/exercise/:chapter()",
    component: () => import('./_chapter_-BqoHqkXU.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BcQsr6-s.mjs')
  },
  {
    name: "course",
    path: "/course",
    component: () => import('./index-Bdme_HGa.mjs')
  },
  {
    name: "methods",
    path: "/methods",
    component: () => import('./methods-TDUaVyIN.mjs')
  },
  {
    name: "study",
    path: "/study",
    component: () => import('./study-kSeD-7c1.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BcAnKa_n.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-yI2-rr9u.mjs').then((m) => m.default || m))
};
