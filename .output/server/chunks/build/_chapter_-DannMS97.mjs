import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, withAsyncContext, mergeProps, unref, withCtx, createVNode, toDisplayString, toRaw, resolveComponent, defineAsyncComponent, defineComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext, createElementBlock, shallowRef, provide, cloneVNode, isRef, toValue, onServerPrefetch, ref, nextTick, toRef } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
import { D as pascalCase, E as kebabCase, F as withoutTrailingSlash, d as destr, G as getRequestHeaders } from '../_/nitro.mjs';
import { find, html } from 'property-information';
import { toHast } from 'minimark/hast';
import { e as useRoute, f as useSeoMeta, t as tryUseNuxtApp, a as useRuntimeConfig, b as useNuxtApp, c as asyncDataDefaults, d as createError } from './server.mjs';
...
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "ContentRenderer" });
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "course-sidebar" }, _attrs))} data-v-b96ea2ab><h3 class="course-sidebar__title" data-v-b96ea2ab>章节目录</h3><nav class="course-sidebar__list" data-v-b96ea2ab><!--[-->`);
      ssrRenderList(__props.chapters, (chapter) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: chapter.slug,
          to: `/courses/${__props.courseId}/${chapter.slug}`,
          class: ["course-sidebar__item", { "course-sidebar__item--active": chapter.slug === __props.currentSlug }]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="course-sidebar__order" data-v-b96ea2ab${_scopeId}>${ssrInterpolate(chapter.order)}</span><span class="course-sidebar__name" data-v-b96ea2ab${_scopeId}>${ssrInterpolate(chapter.title)}</span>`);
            } else {
              return [
                createVNode("span", { class: "course-sidebar__order" }, toDisplayString(chapter.order), 1),
                createVNode("span", { class: "course-sidebar__name" }, toDisplayString(chapter.title), 1)
              ];
            }
          }),
          _: 2
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/course/CourseSidebar.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const CourseSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b96ea2ab"]]);
defineComponent({
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { getCourse, getChapter } = useCourse();
    ...
    const { data: chapterDoc } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `chapter-${courseSlug.value}-${chapterSlug.value}`,
      () => {
        return queryCollection("chapters").path(`/courses/${courseSlug.value}/${chapterSlug.value}`).first();
      },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "chapter-page" }, _attrs))} data-v-45fc1511><div class="container" data-v-45fc1511><div class="chapter-page__layout" data-v-45fc1511><aside class="chapter-page__sidebar" data-v-45fc1511>`);
      _push(ssrRenderComponent(CourseSidebar, {
        "course-id": course.value.id,
        chapters: course.value.chapters,
        "current-slug": chapterSlug.value
      }, null, _parent));
      _push(`</aside><article class="chapter-page__content" data-v-45fc1511>`);
      if (unref(chapterDoc)) {
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(chapterDoc) }, null, _parent));
      } else {
        _push(`<div class="chapter-page__empty" data-v-45fc1511><p data-v-45fc1511>章节内容加载中...</p></div>`);
      }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/courses/[slug]/[chapter].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _chapter_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-45fc1511"]]);

export { _chapter_ as default };
//# sourceMappingURL=_chapter_-DannMS97.mjs.map
