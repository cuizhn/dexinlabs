 ...
 * - 文本类 Block 的 content 为 Markdown 行内语法
 * - version 字段支持未来结构迁移
 */
 ...
 * ParagraphBlock - 段落
 *
 * 最基本的文本块，content 为 Markdown 行内内容。
 */
export interface ParagraphBlock extends BaseBlock {
  type: 'paragraph'
  /** Markdown 行内内容（支持 bold/italic/code/link/math 等） */
  content: string
}
 ...
 *
 * Exercise 有多个 Markdown 字段（body/description/hint/answer/analysis），
