...
.verify__option:hover {
  border-color: var(--home-muted, var(--color-text-muted));
}

.verify__option.is-selected {
  border-color: var(--home-accent, var(--color-primary));
  background: var(--home-accent-soft, var(--color-primary-light));
}
...
.verify__marker {
  ...
  width: 14px;
  height: 14px;
  border: 1px solid var(--home-muted, var(--color-text-muted));
  border-radius: 50%;
...
.verify__option.is-selected .verify__marker {
  border-color: var(--home-accent, var(--color-primary));
  background: var(--home-accent, var(--color-primary));
  box-shadow: inset 0 0 0 3px var(--home-surface, var(--color-bg-white));
}
