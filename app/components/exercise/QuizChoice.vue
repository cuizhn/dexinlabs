<template>
  <div class="quiz-choice">
    ...
    <button v-if="selected !== null && !answered" class="quiz-choice__submit btn btn--primary" @click="submitAnswer">
      提交答案
    </button>

    <div
      v-if="answered"
      class="quiz-choice__feedback"
      :class="isCorrect ? 'quiz-choice__feedback--correct' : 'quiz-choice__feedback--wrong'"
    >
