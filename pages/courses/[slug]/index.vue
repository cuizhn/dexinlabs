...
const { data: course } = await useAsyncData(`course-${route.params.slug}`, () => getCourse(route.params.slug))
...
.course-detail-page__title { font-size: 2rem; font-weight: 700; margin: 0 0 var(--spacing-sm) 0; }
...
.course-detail-page__section-title { font-size: 1.25rem; font-weight: 600; margin: 0 0 var(--spacing-lg) 0; }
...
.course-detail-page__chapter-card:hover { border-color: var(--color-primary); box-shadow: var(--shadow-md); }
...
.course-detail-page__chapter-title { font-size: 1rem; font-weight: 500; margin: 0; }
...
.course-detail-page__info-title { font-size: 1rem; font-weight: 600; margin: 0 0 var(--spacing-md) 0; }
...
.course-detail-page__info-value { font-size: 0.875rem; font-weight: 500; }
.course-detail-page__start-btn { display: block; width: 100%; padding: var(--spacing-sm) var(--spacing-md); background-color: var(--color-primary); color: #fff; text-align: center; text-decoration: none; border-radius: var(--border-radius-md); font-weight: 500; }
