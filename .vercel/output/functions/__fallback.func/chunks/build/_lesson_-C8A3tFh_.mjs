  ...
  async setup(__props) {
    ...
    useHead({
      title: computed(() => {
        ...
        if (currentChapter.value?.title) parts.push(currentChapter.value.title);
        parts.push("课时");
        return parts.join(" · ");
      })
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lesson-detail" }, _attrs))} data-v-706af534><section class="lesson-detail__header" data-v-706af534><div class="container lesson-detail__container" data-v-706af534><nav class="lesson-detail__breadcrumb" data-v-706af534>`);
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-706af534>/</span>`);
      if (unref(chapterSlug)) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(unref(currentChapter)?.title || "章节")}`);
            } else {
              return [
                createTextVNode(toDisplayString(unref(currentChapter)?.title || "章节"), 1)
              ];
            }
          }),
          _: 1
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-706af534>/</span><span class="lesson-detail__bc-current" data-v-706af534>${ssrInterpolate(unref(lesson)?.title || "课时")}</span></nav></div></section><section class="lesson-detail__body" data-v-706af534><div class="container lesson-detail__container" data-v-706af534>`);
      if (unref(loading)) {
        _push(`<div class="lesson-detail__empty" data-v-706af534>课时内容加载中...</div>`);
      } else if (unref(lesson)) {
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(lesson) }, null, _parent));
      } else {
        _push(`<div class="lesson-detail__empty" data-v-706af534>课时内容未找到</div>`);
      }
...
const _lesson_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-706af534"]]);

export { _lesson_ as default };
//# sourceMappingURL=_lesson_-C8A3tFh_.mjs.map
