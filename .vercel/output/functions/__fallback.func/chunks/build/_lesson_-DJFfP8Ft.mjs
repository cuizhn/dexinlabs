...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lesson-detail" }, _attrs))} data-v-bcf99ee5><section class="lesson-detail__header" data-v-bcf99ee5><div class="container lesson-detail__container" data-v-bcf99ee5><nav class="lesson-detail__breadcrumb" data-v-bcf99ee5>`);
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-bcf99ee5>/</span>`);
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-bcf99ee5>/</span><span class="lesson-detail__bc-current" data-v-bcf99ee5>${ssrInterpolate(unref(lesson)?.title || "课时")}</span></nav></div></section><section class="lesson-detail__body" data-v-bcf99ee5><div class="container lesson-detail__container" data-v-bcf99ee5>`);
      if (unref(loading)) {
        _push(`<div class="lesson-detail__empty" data-v-bcf99ee5>课时内容加载中...</div>`);
      } else if (unref(lesson)) {
        _push(ssrRenderComponent(MarkdownRenderer, { value: unref(lesson) }, null, _parent));
      } else {
        _push(`<div class="lesson-detail__empty" data-v-bcf99ee5>课时内容未找到</div>`);
      }
...
const _lesson_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bcf99ee5"]]);

export { _lesson_ as default };
//# sourceMappingURL=_lesson_-DJFfP8Ft.mjs.map
