...
const styles = {
  ...
  "pages/course/[chapter]/[lesson].vue": () => import('./_lesson_-styles.Dz2zK_t0.mjs').then(interopDefault),
  "pages/exercise/[chapter].vue": () => import('./_chapter_-styles.CdlLzwBy.mjs').then(interopDefault),
  ...
  "render/theme/MarkdownRenderer.vue": () => import('./MarkdownRenderer-styles._se8mUiO.mjs').then(interopDefault),
  "../node_modules/nuxt/dist/app/components/error-404.vue": () => import('./error-404-styles.C8lgdT6t.mjs').then(interopDefault),
  "layouts/default.vue": () => import('./default-styles.C-K07qKm.mjs').then(interopDefault),
  "components/app/Header.vue": () => import('./Header-styles.jxn8OHhh.mjs').then(interopDefault),
  "components/app/Footer.vue": () => import('./Footer-styles.BpmEpwny.mjs').then(interopDefault)
};
