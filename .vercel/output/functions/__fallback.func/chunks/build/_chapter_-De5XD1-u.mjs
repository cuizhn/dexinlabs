...
import { _ as _export_sfc, g as useRoute, f as useHead, M as MarkdownRenderer, u as useAsyncData } from './server.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "exercise-page" }, _attrs))} data-v-6d3a23f4><section class="exercise-page__header" data-v-6d3a23f4><div class="container" data-v-6d3a23f4><nav class="exercise-page__breadcrumb" data-v-6d3a23f4>`);
      ...
      _push(`<span class="exercise-page__bc-sep" data-v-6d3a23f4>/</span>`);
      ...
      _push(`<span class="exercise-page__bc-sep" data-v-6d3a23f4>/</span><span class="exercise-page__bc-current" data-v-6d3a23f4>章节练习</span></nav><h1 class="exercise-page__title" data-v-6d3a23f4>${ssrInterpolate(chapterTitle.value ? `${chapterTitle.value} · 练习` : "章节练习")}</h1><p class="exercise-page__desc" data-v-6d3a23f4> 思考 → 尝试 → 提示 → 修正 → 理解 → 总结 → 迁移。让每一次练习都成为思维的生长。 </p></div></section><section class="exercise-page__body" data-v-6d3a23f4><div class="container exercise-page__container" data-v-6d3a23f4>`);
      if (loading.value) {
        _push(`<div class="exercise-page__empty" data-v-6d3a23f4>练习内容加载中...</div>`);
      } else if (unref(exercise)) {
        _push(`<!--[--><h2 class="exercise-page__section-title" data-v-6d3a23f4>${ssrInterpolate(unref(exercise).title || "练习题")}</h2>`);
        if (unref(exercise).description) {
          _push(`<div class="exercise-page__intro" data-v-6d3a23f4>${ssrInterpolate(unref(exercise).description)}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(exercise)) {
        ...
        _push(`<div class="exercise-page__placeholder" data-v-6d3a23f4><div class="placeholder-card" data-v-6d3a23f4><div class="placeholder-card__icon" data-v-6d3a23f4>✎</div><h3 class="placeholder-card__title" data-v-6d3a23f4>练习内容准备中</h3><p class="placeholder-card__desc" data-v-6d3a23f4> 本章节的交互练习正在精心设计中。请先完成课时学习，扎实掌握每个概念。 </p>`);
        if (unref(chapterSlug)) {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/course/${unref(chapterSlug)}`,
...
const _chapter_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d3a23f4"]]);

export { _chapter_ as default };
//# sourceMappingURL=_chapter_-De5XD1-u.mjs.map
