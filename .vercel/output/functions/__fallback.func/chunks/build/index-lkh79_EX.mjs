...
import { computed, resolveComponent, mergeProps, withCtx, createTextVNode, openBlock, createBlock, createVNode, useSSRContext } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_HomeFeatureGrid = resolveComponent("HomeFeatureGrid");
      const _component_HomeCTASection = resolveComponent("HomeCTASection");
...
//# sourceMappingURL=index-lkh79_EX.mjs.map
