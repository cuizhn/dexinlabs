...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lesson-detail" }, _attrs))} data-v-741bc252><section class="lesson-detail__header" data-v-741bc252><div class="container lesson-detail__container" data-v-741bc252><nav class="lesson-detail__breadcrumb" data-v-741bc252>`);
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-741bc252>/</span>`);
      ...
      _push(`<span class="lesson-detail__bc-sep" data-v-741bc252>/</span><span class="lesson-detail__bc-current" data-v-741bc252>${ssrInterpolate(unref(lesson)?.title || "课时")}</span></nav></div></section><section class="lesson-detail__body" data-v-741bc252><div class="container lesson-detail__container" data-v-741bc252>`);
      if (unref(loading)) {
        _push(`<div class="lesson-detail__empty" data-v-741bc252>课时内容加载中...</div>`);
      } else if (unref(lesson)) {
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(lesson) }, null, _parent));
      } else {
        _push(`<div class="lesson-detail__empty" data-v-741bc252>课时内容未找到</div>`);
      }
...
const _lesson_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-741bc252"]]);

export { _lesson_ as default };
//# sourceMappingURL=_lesson_-B7OK-fXS.mjs.map
