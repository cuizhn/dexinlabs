...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "app-header" }, _attrs))} data-v-fc546df6><div class="app-header__container" data-v-fc546df6>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="app-header__logo-icon" data-v-fc546df6${_scopeId}>∑</span><span class="app-header__logo-text" data-v-fc546df6${_scopeId}>Dexin Labs</span>`);
          } else {
            return [
      ...
      _push(`<nav class="app-header__nav" data-v-fc546df6><!--[-->`);
      ...
      _push(`<!--]--></nav><button class="app-header__menu-btn" aria-label="切换导航菜单" data-v-fc546df6><span class="${ssrRenderClass([{ "app-header__menu-icon--open": isMenuOpen.value }, "app-header__menu-icon"])}" data-v-fc546df6></span></button></div><nav class="${ssrRenderClass([{ "app-header__mobile-nav--open": isMenuOpen.value }, "app-header__mobile-nav"])}" data-v-fc546df6><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: item.path,
          to: item.path,
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fc546df6"]]);
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-D8S7df8D.mjs.map
