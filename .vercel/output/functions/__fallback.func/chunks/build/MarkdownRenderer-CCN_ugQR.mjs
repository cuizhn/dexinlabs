...
import { h as getEngine$1 } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d8601fbb>`);
      ssrRenderSlot(_ctx.$slots, "header", {
        toc: toc.value,
        frontmatter: frontmatter.value
      }, null, _push, _parent);
      _push(`<div class="${ssrRenderClass([innerClass.value, "ce-content-body"])}" data-v-d8601fbb>`);
      ssrRenderSlot(_ctx.$slots, "body-start", {}, null, _push, _parent);
      if (renderedHtml.value) {
        _push(`<div class="ce-markdown" data-v-d8601fbb>${renderedHtml.value ?? ""}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const MarkdownRenderer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8601fbb"]]);

export { MarkdownRenderer as M };
//# sourceMappingURL=MarkdownRenderer-CCN_ugQR.mjs.map
